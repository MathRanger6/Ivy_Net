...
*Companion docs: [`docs/GIT_MULTIPLE_MACHINES_ELEMENTARY.md`](../docs/GIT_MULTIPLE_MACHINES_ELEMENTARY.md), [`docs/GIT_FOR_DUMMIES.md`](../docs/GIT_FOR_DUMMIES.md), [`RIVANNA_CURSOR_REMOTE_SSH_FOR_DUMMIES.md`](./RIVANNA_CURSOR_REMOTE_SSH_FOR_DUMMIES.md), [`TENURE_STREAMLINING_AND_RESEARCH_PRIORITIES.md`](./TENURE_STREAMLINING_AND_RESEARCH_PRIORITIES.md).*
