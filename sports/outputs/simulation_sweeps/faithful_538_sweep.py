...
def _assignment_params(sc: Scenario) -> tpa.AssignmentParams:
    return tpa.AssignmentParams(
        ...
        assignment_rho=_BASE_PARAMS.assignment_rho,
        assignment_sigma=_BASE_PARAMS.assignment_sigma,
        use_preferential_attachment=_BASE_PARAMS.use_preferential_attachment,
