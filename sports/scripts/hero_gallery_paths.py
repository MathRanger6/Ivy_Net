...
POPULATION_SANDBOX = HERO_ROOT / "population_sandbox"
POPULATION_SANDBOX_HERO = POPULATION_SANDBOX / "hero"
POPULATION_SANDBOX_FHERO = POPULATION_SANDBOX / "fhero"
...
_ALL_DIRS = (
    ...
    POPULATION_SANDBOX,
    POPULATION_SANDBOX_HERO,
    POPULATION_SANDBOX_FHERO,
    GRANDCHILD_ASSIGN,
    PD20_TEMPERATURE,
    PD21_MLE,
    PD21_RHO,
