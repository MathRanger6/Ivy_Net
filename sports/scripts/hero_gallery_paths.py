...
BASIC_DATA_PLOTS_SEASON_Y = BASIC_DATA_PLOTS / "season_y_experiment"
SPORTS_SANDBOX = HERO_ROOT / "sports_sandbox"
SPORTS_SANDBOX_HERO = SPORTS_SANDBOX / "hero"
SPORTS_SANDBOX_FHERO = SPORTS_SANDBOX / "fhero"
REIGNING_HERO_BASIC_PLOTS = SPORTS_SANDBOX / "reigning_hero" / "basic_data_plots"
REIGNING_HERO_FHERO = SPORTS_SANDBOX / "reigning_hero" / "fhero"
REIGNING_HERO_CALIBRATION_RHO = SPORTS_SANDBOX / "reigning_hero" / "calibration_rho"
...
_ALL_DIRS = (
    ...
    EMPIRICAL_PD17,
    BASIC_DATA_PLOTS,
    BASIC_DATA_PLOTS_SEASON_Y,
    SPORTS_SANDBOX,
    SPORTS_SANDBOX_HERO,
    SPORTS_SANDBOX_FHERO,
    REIGNING_HERO_BASIC_PLOTS,
    REIGNING_HERO_FHERO,
