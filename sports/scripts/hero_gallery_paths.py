...
HAND_PHASE_B_DECK = SLIDES / "CHAR_Phase_B_characterization_HAND.pptx"
...
_ALL_DIRS = (PASS_A, PASS_B, PASS_C_RHO, SIM_INPUTS, SORT_CHOP_LAMBDA, THETA, SLIDES, SLIDES_AUTO)
