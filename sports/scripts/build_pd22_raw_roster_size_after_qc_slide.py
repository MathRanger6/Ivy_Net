...
SEASON_MIN = 2011
SEASON_MAX = 2021
STEM = f"PD22_raw_roster_size_distribution_{SEASON_MIN}_{SEASON_MAX}_after_qc"
HERO_LOCK = 20.0
NCAA_DRESS = 15
...
def _artifact_paths() -> tuple[Path, Path, Path]:
    ...
    return fig, meta, AUTO_PD22_RAW_ROSTER_SIZE_AFTER_QC_DECK
...
def _max_outlier_bullet(meta: dict) -> str:
    csv_raw = PD22_MINUTES / (
        f"PD22_raw_roster_size_by_team_season_{SEASON_MIN}_{SEASON_MAX}_after_qc_raw.csv"
    )
