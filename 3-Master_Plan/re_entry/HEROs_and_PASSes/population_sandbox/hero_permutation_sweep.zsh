...
# Run from repo root: zsh 3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero_permutation_sweep.zsh
#
# Tiers:
...
echo ""
echo "Done."
echo "  PNGs:     3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero/"
echo "  Manifest: 3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero_permutation_slides/manifest.json"
echo "  Deck:     3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero_permutation_slides/HERO_permutation_slides_AUTO.pptx"
