...
```bash
# From repo root — writes population_sandbox/cli_help_dump.txt
...
| `--output-root` | `pass_a/` or sandbox | Sandbox: `…/population_sandbox/hero` |
...
| `--out-dir` | `basic_data_plots/` | Sandbox: `…/population_sandbox/fhero` |
...
No CLI flags — paths fixed to `population_sandbox/hero/`.
...
|--------|--------|-------------------------------|
| `population_sandbox/hero/` | `pass_a_empirical_bundle.py` | `--output-root …/hero` |
| `population_sandbox/fhero/` | `pass_a_congestion_conditional.py` | `--out-dir …/fhero` |
...
zsh 3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero_permutation_sweep.zsh core
