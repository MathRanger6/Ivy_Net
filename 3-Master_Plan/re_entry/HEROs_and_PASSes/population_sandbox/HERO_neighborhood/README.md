...
python sports/scripts/pass_a_empirical_bundle.py \
  ...
  --output-root 3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/HERO_neighborhood
```
...
```bash
zsh 3-Master_Plan/re_entry/HEROs_and_PASSes/population_sandbox/hero_neighborhood_sweep.zsh
```
