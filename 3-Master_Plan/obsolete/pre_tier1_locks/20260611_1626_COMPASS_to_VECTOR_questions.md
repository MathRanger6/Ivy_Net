...
1. **Charles answer:** Score equation + soft assignment + **explicit axis table** is sufficient for v1 mechanism draft; **not** blocking on LOO-pool-quality generative match. **VECTOR:** confirm §3 claim box and what SCOUT nesting deliverables you need before drafting.

2. **Which Tier 1 objects must appear in the manuscript main text vs supplement?**
...
4. **Prediction list for v1:** COMPASS proposes prioritizing:
   ...
   - (b) peak shift with global \(\Lambda\),
   - (c) mean × dispersion (SCOUT 4B/4C).
