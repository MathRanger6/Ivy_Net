...
1.  **λ ablation panel** --- mirror Pass C's ρ panel: fix ρ, vary λ
    (e.g. four subplots at your four ρ values, or a fixed-ρ sweep).
...
**Things I'll ask you when we write the checklist**

1.  **Board vs screen:** When Alex said "flat without assortativity,"
    was that **Pass C on screen**? (I'm assuming yes.)

2.  **Double-plot target:** Left = $A_{i}$-binned, right =
    poolq_loo-binned, same sim run --- still your read?

3.  **λ sign on Model slide:** You corrected him (λ = 0.55, $L_{C}$
    negative) --- what's on **Model.pptx** now?

4.  **PD14:** Park until after Phase B, or keep as parallel track?
...
When you want, we can archive CHARLES_CHECKLIST.md and draft
a **\~15--20 item PD15 checklist** using **Pass A / B / C as on your
slides**.
