...
# RUN 2: Pool minus mean vs pool rank (percentile), interactive surface.
# Set RUN_SCALE to 'raw' or 'z'; Run 2 uses z by default for apples-to-apples.
...
RUN_PROFILE = {
    'tv_vars': [POOL_MINUS_MEAN_SNR_COL, POOL_TB_RATIO_RANK_PCT_SNR_COL],
    'quadratic_bases': [POOL_MINUS_MEAN_SNR_COL, POOL_TB_RATIO_RANK_PCT_SNR_COL],
    'interaction_name': 'rank_pool_interaction',
    'plot_prefix': 'run2',
    'var_x_label': 'Pool minus mean (z)',
...
if USE_OVERRIDE_CR_PLOTS:
    # Individual CR plots (z-scale; edit per-plot here if needed). Example: {**RUN_CR_PLOT_DEFAULTS, 'n_bins': 5, 'variable': Z_POOL_MINUS_MEAN_SNR_COL, 'name': 'run2_cr_' + Z_POOL_MINUS_MEAN_SNR_COL}
    PLOT_CONFIG['plots'] = [
        {**RUN_CR_PLOT_DEFAULTS, 'variable': Z_POOL_MINUS_MEAN_SNR_COL, 'name': 'run2_cr_' + Z_POOL_MINUS_MEAN_SNR_COL},
        {**RUN_CR_PLOT_DEFAULTS, 'variable': Z_POOL_TB_RATIO_RANK_PCT_SNR_COL, 'name': 'run2_cr_' + Z_POOL_TB_RATIO_RANK_PCT_SNR_COL},
        {**RUN_CR_PLOT_DEFAULTS, 'variable': 'rank_pool_interaction', 'name': 'run2_cr_rank_pool_interaction'},
    ]

# Filtering parameters for RUN 2
